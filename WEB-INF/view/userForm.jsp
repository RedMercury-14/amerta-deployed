...
<title>Создание карточки работника</title>
</head>
...
<div class="container">
  <main>
	...
	<c:url value="/home/hr/save-new-user" var="loginVar"/>
    ...
    <div class="row g-5">
      <div class="col-md-5 col-lg-4 order-md-last">
       ...
       <div class="col-sm-12">
              ...
              <input type="text" list="dep" class="form-control" name="departmentId">
              <datalist id="dep">
       ...
       <div class="col-sm-12">
        ...
        <div class="col-sm-12">
              ...
              <input type="date" class="form-control" name="dateOfEmployment" placeholder="" value="" required>
              <div class="invalid-feedback">
               Введите дату.
              </div>
            </div>
