...
<br>
    <h2 class="pb-2 border-bottom">Отдел кадров</h2>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-2">
      <div class="feature col">
        ...
        <h2>Картотека</h2>
        <p>Просмотр и редактирование работников</p>
        <a href="#" class="icon-link" onclick="alert('Функция временно отключена')">
          Перейти
      ...
      <div class="feature col">
        ...
        <p>Создание новой личной карточки работника</p>
        <a href="/amerta/home/hr/adduser" class="icon-link">
          Перейти
          <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"/></svg>
        </a>
      </div>
